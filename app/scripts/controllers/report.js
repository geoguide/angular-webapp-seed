...
angular.module('modioAdminPortal').controller('ReportCtrl', function ($window, $log, reportFactory, MODIOCORE, API_URL, localStorageService, facilityFactory, doctorFactory, ENV, toasty) {
    ...
    this.licenses = [{
        id: 1,
        provider_name: 'Mernie Bann',
        type_id: 1,
        state: 'MA',
        expiration_date: '12/30/2017',
        expires: '94',
        alerts: 'wtf',
        date_updated: '01/26/2016'
    }];
    ...
    this.getResults = function () {
        ...
        if (_this.selectedFacility && _this.selectedFacility.id) {
            _this.queryData.facility_id = _this.selectedFacility.id;
        } else {
            delete _this.queryData.facility_id;
        }
